...
class CommentsViewModel: ObservableObject {
    ...
    func loadMoreComments() async {
        ...
        // Implementation would use the same postId from the current context
    ...
    func toggleLike(for comment: PostComment) async {
        do {
            ...
            if response.success {
                // Update the comment's like state locally
...
#Preview {
    let samplePost = Post(
        ...
        proofType: .image,
        description: "Just finished my morning workout! Feeling great and ready to tackle the day.",
        privacy: .friends,
